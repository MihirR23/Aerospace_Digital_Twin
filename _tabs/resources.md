...
| Tool | Purpose |
|------|---------|
| Siemens NX | Digital twin simulation and CAD assembly |
| TIA Portal V19 | PLC programming and control logic |
| S7-PLCSIM Advanced 6.0 | Virtual PLC testing |
| SolidWorks | STL to STEP file conversion |
| Python (scikit-learn) | Random Forest fault classification |
