...
Following feedback on the university's risk assessment requirements, I have revised the risk assessment originally documented on [6th February]({{ '/posts/planning-for-failure-risk-assessment/' | relative_url }}) to align with the official PDE3823 template format.
